...
import com.wzf.base.arouter.router.WsRouterParser;
...
public class AboutInterceptor implements IInterceptor {
    ...
    public void process(Postcard postcard, InterceptorCallback callback) {
        ...
        if ("needLogin".equals(groups)) {
            ...
            WsRouterParser.intoLogin(null);
//                ARouter.getInstance().build(RouterPathConstant.ACTIVITY_URL_LOGIN).navigation();
